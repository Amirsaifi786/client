                            ...
                            <div className="card-body">
                                ...
                                <ul className="list-group">
                                    ...
                                    {property.singlePrice  && (
                                        <li className="list-group-item">Single Sharing : ₹{property.singlePrice}</li>
                                    )}

                                    {property.doublePrice  && (
                                        <li className="list-group-item">Double Sharing : ₹{property.doublePrice}</li>
                                    )}

                                    {property.triplePrice && (
                                        <li className="list-group-item">Triple Sharing : ₹{property.triplePrice}</li>
                                    )}
                                </ul>
                            </div>
                        </div>
